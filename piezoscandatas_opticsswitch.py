...
pars.add_argument("--opticscontrol", default="localhost", help="set optics control address")
...
optics = labdrivers.websocks.OpticsControl(args.opticscontrol)
...
for i in range(len(pz)):
    ...
    optics.set_switch("yellow", "B")
    sleep(.1)
    trans1 = d.read()

    #save sa and or megadaq

    optics.set_switch("yellow", "C")
    save_sa(i)
    megasave(i)
