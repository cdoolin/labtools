...
pars.add_argument("ft_start", type=float, help="start wavelength")
pars.add_argument("ft_stop", type=float, help="stop wavelength")
pars.add_argument("ft_step", type=float, help="scan speed")
